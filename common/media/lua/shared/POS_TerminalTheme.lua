...
POS_TerminalTheme.THEMES = {
    -- 1: Classic Green (default)
    {
        ...
        term = {
            ...
            scan      = { r = 0.10, g = 0.20, b = 0.10, a = 0.04 },
            glow      = { r = 0.05, g = 0.15, b = 0.05, a = 0.03 },
            headerBg  = { r = 0.07, g = 0.10, b = 0.07, a = 0.95 },
            statusBg  = { r = 0.07, g = 0.10, b = 0.07, a = 0.95 },
        },
        widgets = {
    ...
    -- 2: Amber
    {
        ...
        term = {
            ...
            err    = { r = 0.90, g = 0.25, b = 0.20 },
            border = { r = 0.40, g = 0.30, b = 0.05, a = 1.0 },
            scan      = { r = 0.20, g = 0.15, b = 0.02, a = 0.04 },
            glow      = { r = 0.15, g = 0.10, b = 0.02, a = 0.03 },
            headerBg  = { r = 0.10, g = 0.07, b = 0.04, a = 0.95 },
            statusBg  = { r = 0.10, g = 0.07, b = 0.04, a = 0.95 },
        },
        widgets = {
    ...
    -- 3: Cool White
    {
        ...
        term = {
            ...
            scan      = { r = 0.15, g = 0.15, b = 0.15, a = 0.04 },
            glow      = { r = 0.10, g = 0.10, b = 0.10, a = 0.03 },
            headerBg  = { r = 0.08, g = 0.08, b = 0.08, a = 0.95 },
            statusBg  = { r = 0.08, g = 0.08, b = 0.08, a = 0.95 },
        },
        widgets = {
    ...
    -- 4: IBM Blue
    {
        ...
        term = {
            ...
            warn   = { r = 0.90, g = 0.80, b = 0.10 },
            err    = { r = 0.90, g = 0.25, b = 0.20 },
            border = { r = 0.15, g = 0.25, b = 0.50, a = 1.0 },
            scan      = { r = 0.05, g = 0.08, b = 0.20, a = 0.04 },
            glow      = { r = 0.03, g = 0.05, b = 0.15, a = 0.03 },
            headerBg  = { r = 0.04, g = 0.05, b = 0.10, a = 0.95 },
            statusBg  = { r = 0.04, g = 0.05, b = 0.10, a = 0.95 },
        },
        widgets = {
